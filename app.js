...
app.use(express.json()) // to send file in json or say object
app.use(express.urlencoded({ extended: true })) // send this file in form format
...
app.get('/fetchallnotes', auth, async (req, res) => {
    try {
...
// we use :id because every note has unique id that can delete or edit
app.put('/updatenote/:id', auth, async (req, res) => {
    const { title, description, tag } = req.body;
    try {
